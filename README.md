...
![](https://res.cloudinary.com/dsu4khzr3/image/upload/v1674189434/schema3_cvwbrk.png)
...
* Request
  * Method: GET
  * URL: /api/spots
  <!-- ?filter=[{page:integer,size:integer,minLat:decimal,maxLat:decimal,minLng:decimal,maxLng:decimal,minPrice:decimal,maxPrice:decimal}]/ -->
  * Query Parameters
